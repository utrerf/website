...
function ThemeSwitch() {
  ...
  }, mounted && (theme === "dark" || resolvedTheme === "dark") ? /* @__PURE__ */ React.createElement("svg", {
    fill: "none",
    viewBox: "0 0 24 24",
    width: "24",
    height: "24",
...
function Meta({ author, date, tag, back, config }) {
  ...
  const dateNode = date ? /* @__PURE__ */ React2.createElement("time", null, new Date(date).toDateString()) : null;
  ...
  return /* @__PURE__ */ React2.createElement("div", {
    ...
    className: "meta-back"
  }, "Back")) : null, config.darkMode && /* @__PURE__ */ React2.createElement(ThemeSwitch, null));
}
...
function Nav({ navPages, config }) {
  ...
  }), config.darkMode && /* @__PURE__ */ React3.createElement(ThemeSwitch, null));
}
...
var HeaderLink = (_a) => {
  ...
  return /* @__PURE__ */ React4.createElement(Tag, __spreadValues({}, props), /* @__PURE__ */ React4.createElement("span", {
...
var H2 = (_a) => {
  ...
  return /* @__PURE__ */ React4.createElement(HeaderLink, __spreadValues({
    tag: "h2"
  }, props), children);
};
var H3 = (_a) => {
...
var A = (_a) => {
  ...
  if (isExternal) {
    return /* @__PURE__ */ React4.createElement("a", __spreadValues({
      target: "_blank",
      rel: "noreferrer"
    }, props), children);
  }
  return /* @__PURE__ */ React4.createElement(Link3, {
    href: props.href
  }, /* @__PURE__ */ React4.createElement("a", __spreadValues({}, props), children));
};
var Code = (_a) => {
  ...
  if (!className)
    return /* @__PURE__ */ React4.createElement("code", __spreadValues({}, props), children);
  const language = className.replace(/language-/, "");
  return /* @__PURE__ */ React4.createElement(Highlight, __spreadProps(__spreadValues({}, defaultProps), {
    code: children.trim(),
    language,
    theme: THEME
  }), ({ className: className2, style, tokens, getLineProps, getTokenProps }) => /* @__PURE__ */ React4.createElement("code", {
    className: className2,
    style: __spreadValues({}, style)
  }, tokens.map((line, i) => /* @__PURE__ */ React4.createElement("div", __spreadProps(__spreadValues({
    key: i
  ...
  }), line.map((token, key) => /* @__PURE__ */ React4.createElement("span", __spreadValues({
    key
...
var mdx_theme_default = ({ children }) => {
  ...
  return /* @__PURE__ */ React4.createElement(SluggerContext.Provider, {
    value: slugger
  }, /* @__PURE__ */ React4.createElement(MDXProvider, {
    components
  }, children));
};
...
// src/index.js
var ReactCusdis = dynamic(() => import("react-cusdis").then((mod) => mod.ReactCusdis), { ssr: false });
var Layout = ({
  config,
  meta,
  navPages,
  ...
  return /* @__PURE__ */ React6.createElement(React6.Fragment, null, /* @__PURE__ */ React6.createElement(Head, null, /* @__PURE__ */ React6.createElement("title", null, pageTitle, config.titleSuffix), config.head ? config.head({ title, meta }) : null), /* @__PURE__ */ React6.createElement("article", {
    className: "container prose prose-sm md:prose dark:prose-dark"
  }, titleNode || /* @__PURE__ */ React6.createElement("h1", null, pageTitle), type === "post" ? /* @__PURE__ */ React6.createElement(Meta, __spreadProps(__spreadValues({}, meta), {
    back,
    config
  })) : /* @__PURE__ */ React6.createElement(Nav, {
    navPages,
    config
  }), /* @__PURE__ */ React6.createElement(mdx_theme_default, null, contentNodes, type === "post" ? config.postFooter : null, type === "post" ? comments : null), postList, config.footer));
};
var src_default = (opts, _config) => {
  ...
  const config = Object.assign({
    readMore: "Read More \u2192",
    footer: /* @__PURE__ */ React6.createElement("small", {
  ...
  return (props) => {
    ...
    const pageTitle = opts.meta.title || (typeof tagName === "undefined" ? null : titleNode ? ReactDOMServer2.renderToStaticMarkup(titleNode.props.children) : null) || "";
    let comments;
    if (config.cusdis) {
    ...
    const postList = posts ? /* @__PURE__ */ React6.createElement("ul", null, posts.map((post) => {
      if (tagName) {
      ...
      const postDate = post.frontMatter ? /* @__PURE__ */ React6.createElement("time", {
        className: "post-item-date"
      }, new Date(post.frontMatter.date).toDateString()) : null;
      const postDescription = post.frontMatter && post.frontMatter.description ? /* @__PURE__ */ React6.createElement("p", {
        className: "post-item-desc"
      }, post.frontMatter.description, config.readMore ? /* @__PURE__ */ React6.createElement(Link4, {
        href: post.route
      ...
      return /* @__PURE__ */ React6.createElement("div", {
        key: post.route,
        className: "post-item"
      }, /* @__PURE__ */ React6.createElement("h3", null, /* @__PURE__ */ React6.createElement(Link4, {
        href: post.route
      }, /* @__PURE__ */ React6.createElement("a", {
    ...
    return /* @__PURE__ */ React6.createElement(ThemeProvider, {
      ...
      defaultTheme: "system",
      enableSystem: true
    }, /* @__PURE__ */ React6.createElement(Layout, __spreadValues(__spreadValues({
      config,
      postList,
      navPages,
      back,
